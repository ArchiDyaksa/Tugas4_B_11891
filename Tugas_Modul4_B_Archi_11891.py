...
st.set_page_config(
    page_title="11891 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Archi</h1>", unsafe_allow_html=True) 
    st.dataframe(input_data)

    # Direktori tempat penyimpanan model
    model_directory = r'E:\SEMESTER 5\ML&DL\Unsupervised Learning (Praktek)\Tugas4_B_11891'
    model_path = {
